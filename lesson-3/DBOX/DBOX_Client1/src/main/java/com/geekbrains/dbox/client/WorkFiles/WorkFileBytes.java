...
import com.geekbrains.dbox.client.WorkFiles.Data_File.JobInFiles;
import com.geekbrains.dbox.client.WorkFiles.Data_File.MD5Checksum;
import com.geekbrains.dbox.client.WorkFiles.Data_File.MainFileClass;
import com.geekbrains.dbox.client.WorkFiles.Data_File.WorkFileLinesMod;
...
public class WorkFileBytes extends MainFileClass implements JobInFiles {
    ...
    public WorkFileBytes(String pathNameFile) {
        super(pathNameFile);
    }
    ...
    public int getSizeReadeArrByte() {
        return sizeReadeArrByte;
    }

    public void setSizeReadeArrByte(int sizeReadeArrByte) {
        this.sizeReadeArrByte = sizeReadeArrByte;
    }
    ...
    public long getSizeFile(){
        ...
        if (file.isFile()){
            ...
            System.out.print("\"" + this.pathNameFile + "\" " + "Файл не существует" );
        }
    ...
    public boolean isFile(){
        File file = new File(this.pathNameFile.trim());
        return file.isFile();
    }
}
