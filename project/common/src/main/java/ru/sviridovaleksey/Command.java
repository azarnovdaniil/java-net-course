...
public class Command implements Serializable {
    ...
    public static Command renameFile(String userName, String oldName, String newName) {
        Command command = new Command();
        command.type = TypeCommand.RENAME_FILE;
        command.data = new RenameFile(userName, oldName, newName);
        return command;
    }
}
