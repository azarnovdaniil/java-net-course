...
public class HelloMessage {
    ...
    public void helloMessage() {
        ...
        System.out.println("0 - отменить действие; a - обновить; 1 - создать директорию; 2 - удалить директорию; 3 - создать файл; 4 - удалить файл");
        System.out.println("5 - копировать файл; 6 - Вставить файл; 7 - отправить сообщение на сервер; 8 - открыть директорию;" +
                " 9 - назад; 10 - отправить файл на сервер; 11 - скачать файл");
    }
